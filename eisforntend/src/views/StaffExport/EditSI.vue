        ...
        ========================================================
          ...
          <v-container>
            <v-form v-model="valid">
              ...
              <v-text-field label="Liner" :value="konten.liner" v-model="konten.liner" disabled/>
              <v-select
                ...
                disabled
              />
              <v-text-field label="Invoice" :value="konten.invoice" v-model="konten.invoice"/>
              <v-text-field
                label="Vessel"
...
export default {
  ...
  mounted() {
    var id = this.$session.get("id_role");
    this.idstaff = id;
