...
export default {
    ...
    mounted () {
        if(this.$route.query.period === undefined){
            ...
            var url = 'http://mciexport.herokuapp.com/api/getReport?date='+today + '&period=weekly'
            console.log(url)
            Axios.get(url)
            .then(response => { 
            ...
            var url = 'http://mciexport.herokuapp.com/api/getReport?period='+ period  +  '&date='+date
            console.log(url)
            Axios.get(url)
            .then(response => { 
            console.log(response.data.result)
  ...
  methods :{
      ...
      changePeriod(input){  
          console.log("masuk")
          this.$router.push({path :'/manager/report/transaction', query : {date : input.date, period : input.period}} )
          location.reload()
      }
  },
